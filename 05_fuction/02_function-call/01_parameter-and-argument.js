...
// console.log(name);   -> {} 밖에서 사용 불가

// console.log(hello('이도아'));
var result = hello('이도아');
console.log(result);
...
function hi(name = '아무개'){
    ...
    // 적잘한 인수가 전달 되었는 지 확인하는 방법
    if(arguments.length !== 1 || typeof name !== 'string' || name.length === 0){
        throw new TypeError('인수는 1개여야 하고, 문자열 값이며, 빈 문자열은 허용되지 않습니다.!!!');
    }
