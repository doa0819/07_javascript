...
// const 키워드는 반드시 선언과 동시에 초기화를 해야 한다.
// const x;  -> Syntax Error 발생 //  선언만 하고 초기화를 하지 않았다.
const x = 10;
...
// student 에 객체의 주소값은 변경 할 수 없지만, 프로퍼티들의 값은 변경 할 수 있다.
// student = {};
...
/* ES6
    ...
    => const 로 다 선언하고 재할당이 필요한 경우에만 let 사용
 */
